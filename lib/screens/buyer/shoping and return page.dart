...
class shopingreturn extends StatefulWidget {

  shopingreturn({Key? key}) : super(key: key);
  // final currentUser=FirebaseAuth.instance;
  // _docRef=FirebaseFirestore.instance.collection("ProductRegistration").doc(id);


  @override
  State<shopingreturn> createState() => _shopingreturnState();
}

class _shopingreturnState extends State<shopingreturn> {
  ...
  Widget build(BuildContext context) {
                      ...
                      children: [
                        Align(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left: 20),
                            child: Text('OVERVIEW '
                               ' This website is operated by Tap N Buy. Throughout the site, the terms “we”, “us” and “our” refer to Tap N Buy. Tap N Buy offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.'
    ...
    // In no case shall Tap N Buy, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
    //
    // SECTION 14 - INDEMNIFICATION
    // You agree to indemnify, defend and hold harmless Tap N Buy and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
    //
    ...
    // Questions about the Terms of Service should be sent to us at: support@TapNBuy
    // [9:59 AM, 4/26/2023] Abdullah Uni: REFUND POLICY
    ...
    //
    // Returns
    // We ask that if you wish to return an item purchased that you return the item using the same packaging that it was delivered with. All returns are subject to evaluation by Tap N Buy staff.
    // When mailing a return:
    // •	All returns must be authorized by Tap N Buy in advance (our warehouse can’t accept returns without a valid return number).
    ...
    'You can always contact us for any return question at support@TapNBuy.com.'
                                ,style: TextStyle(
